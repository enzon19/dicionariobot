<p align="center">
  ...
  <br><br>
    <a href="https://github.com/enzon19/dicionariobot/blob/main/README.pt-BR.md#20">
        <img height="20px" src="https://img.shields.io/badge/Vers%C3%A3o%20Atual-v2.0-ee2919">
    </a>
...
O bot está hospedado no [Replit](https://replit.com), e os tokens de APIs estão salvos em arquivos .env no Replit. Ainda estou aprendendo estas linguagens e por isso os códigos podem não ser os melhores.
