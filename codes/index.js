...
bot.on('message', async (msg) => {
  ...
  if (msg.text != undefined) {
    ...
    for (i = 0; i < contentList.length; i++) {
      ...
      if (list[0].indexOf(removeAccents.remove(contentList[i])) != -1) bot.sendMessage(msg.chat.id, (list[1][list[0].indexOf(removeAccents.remove(contentList[i]))]) + "*", { reply_to_message_id: msg.message_id, disable_notification: true });
      ...
      switch (command) {
        ...
        case '/add':
          ...
          if (msg.from.id == "1097090528") {
            ...
            list[0].push(content.split(" ")[1].split("_")[0]);
